...
#ifndef EKOSCAPE_MAPS_MAP_H_
#define EKOSCAPE_MAPS_MAP_H_
...
public:
  ...
  static constexpr Range2i kSupportedVersions{1,1};
  static constexpr Duration kMinRobotDelay = Duration::from_millis(110);
...
protected:
  static constexpr const auto* kHeaderFmt = "[EkoScape/v{}]";
