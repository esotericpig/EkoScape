...
#ifndef EKOSCAPE_MAPS_SPACE_TYPE_H_
#define EKOSCAPE_MAPS_SPACE_TYPE_H_
...
namespace SpaceTypes {
  inline const SpaceType kFallback = SpaceType::kVoid;

  bool is_valid(SpaceType type);
  bool is_valid_empty(SpaceType type);
