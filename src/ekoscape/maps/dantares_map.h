...
#ifndef EKOSCAPE_MAPS_DANTARES_MAP_H_
#define EKOSCAPE_MAPS_DANTARES_MAP_H_
...
public:
  using SetTextures = std::function<void(Dantares2&,int z,int grid_id)>;

  explicit DantaresMap(Dantares2& dantares,SetTextures set_textures);
