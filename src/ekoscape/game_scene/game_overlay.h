...
#ifndef EKOSCAPE_GAME_SCENE_GAME_OVERLAY_H_
#define EKOSCAPE_GAME_SCENE_GAME_OVERLAY_H_
...
public:
  ...
  void update_logic(const FrameDelta& delta,const SceneContext& ctx);
...
private:
  ...
  static constexpr Color4f kTextBgColor{0.0f,0.5f};
  static constexpr Size2i kTextBgPadding{15,10};
