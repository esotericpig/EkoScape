...
private:
  static constexpr int kLikeStatue = 1 << 0; // No movement.
  static constexpr int kLikeNormal = 1 << 1;
  static constexpr int kLikeGhost = 1 << 2; // Can go through walls.
  static constexpr int kLikeSnake = 1 << 3; // Leaves behind a tail of statues.

  static constexpr float kDefaultLifespan = 0.0f; // 0.0f is immortal.
  static constexpr float kSnakeTailLifespan = 9.0f;
