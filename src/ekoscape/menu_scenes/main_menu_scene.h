...
#ifndef EKOSCAPE_MENU_SCENES_MAIN_MENU_SCENE_H_
#define EKOSCAPE_MENU_SCENES_MAIN_MENU_SCENE_H_
...
public:
  explicit MainMenuScene(GameSession& sesh,SceneContext& ctx);
...
private:
  ...
  public:
    ...
    explicit Option(std::string_view text,OnSelect on_select);
